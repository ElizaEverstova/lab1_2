...
class Movie{
    ...
    Movie(String nameW, String countryW, String genreW, int yearW, double priceW){
        name = nameW;
        country = countryW;
        genre = genreW;
        year = yearW;
    ...
    @Override
    public String toString() { return (this.name + " "+ this.country+" "+ this.genre+" "+ this.year+" "+ this.price);}
}
